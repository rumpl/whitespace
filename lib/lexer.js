...
Lexer.prototype.parseLabel = function () {
  var ret = '';
...
Lexer.prototype.stackManipulation = function () {
  ...
  throw new Error('Unknown stack manipulation operation ' +  this.debug(op));
};
...
Lexer.prototype.arithmetic = function () {
  ...
  throw new Error('Unknown arithmetic operation ' + this.debug(op));
};
...
Lexer.prototype.heapAccess = function () {
  ...
  throw new Error('Unknown heap access operation ' + this.debug(op));
};
...
Lexer.prototype.flowControl = function () {
  ...
  throw new Error('Unknown flow control operation ' + this.debug(op));
};
...
Lexer.prototype.io = function () {
  ...
  throw new Error('Unknown io operation ' + this.debug(op));
};
